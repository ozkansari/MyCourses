...
public class SparkOrnek1 {
    ...
    private static void urunSilmeIslemi() {
        FreeMarkerRoute urunSilmeIslemi = new FreeMarkerRoute("/urunsil") {
            ...
            public Object handle(Request istek, Response cevap) {
                ...
                cevap.redirect("/havva_akbas/urunler");
        ...
        FreeMarkerRoute urunEkleIslemi = new FreeMarkerRoute("/urunekle") {
            ...
            public Object handle(Request istek, Response cevap) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    cevap.redirect("/havva_akbas/urunekle");
                    return null;
                }
    ...
    private static void urunEklemeSayfasi() {
        FreeMarkerRoute urunEkleSayfasi = new FreeMarkerRoute("/havva_akbas/urunekle") {
            @Override
            public Object handle(Request arg0, Response arg1) {
                Map<String, Object> ozellikler = new HashMap<String, Object>();
                ozellikler.put("urunler", URUNLER);
                return new ModelAndView(ozellikler, "/havvagamzeakbas/urunekle.html");
            }
        };
        get(urunEkleSayfasi);
    }
    ...
    private static void urunleriGoruntule() {
        FreeMarkerRoute sayfa3 = new FreeMarkerRoute("/havva_akbas/urunler") {
            @Override
            public Object handle(Request arg0, Response arg1) {
                ...
                // ozellikler.put("urunler", URUNLER);
                ozellikler.put("urunler", urunler);
                return new ModelAndView(ozellikler, "/havvagamzeakbas/urunler.html");
            }
        };
        get(sayfa3);
    }
    private static void admin() {
        FreeMarkerRoute admin = new FreeMarkerRoute("/havva_akbas/admin") {
            @Override
            public Object handle(Request arg0, Response arg1) {
                ...
                // ozellikler.put("urunler", URUNLER);
                ozellikler.put("urunler", urunler);
                return new ModelAndView(ozellikler, "/havvagamzeakbas/Admin.html");
            }
        };
        get(admin);
    }
    ...
    private static void urunlerJson() {
        Route sayfa2 = new Route("/havva_akbas/urunler/json") {
            public Object handle(Request istek, Response cevap) {
                List<Urun> urunler = DerbyVeritabaniOrnek.kayitlariAl();
    ...
    private static void baslangic() {
        FreeMarkerRoute baslangic = new FreeMarkerRoute("/havva_akbas/anasayfa") {
            @Override
            public Object handle(Request arg0, Response arg1) {
                ...
                // ozellikler.put("urunler", URUNLER);
                ozellikler.put("urunler", urunler);
                return new ModelAndView(ozellikler, "/havvagamzeakbas/Anasayfa.html");
            }
        };
        get(baslangic);
    }
