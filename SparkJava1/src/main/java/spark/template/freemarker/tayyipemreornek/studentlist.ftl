    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="/studentlist">Ögrenci Listesi</a></li>
...
<div class="container">
    <div class="jumbotron">
        <center>
           <form action="/studentshow" method="POST" accept-charset="utf-8">
                <h1>Medipol Üniversitesi Ögrenci Listesi</h1>
                <table border="2" width="1000">
                    <center>
                        <td colspan="3"><a href="/studentshow"><center><input type="submit" class="btn btn-default" value="Seçili Öğrenciyi Detaylı Görüntüle"/></center></a></td>
                    </center>
                    <tr>
                    ...
                    <#list students as students>
                        <tr>
                            ...
                            <td><center><input type="radio" id="shows" name="shows" value="${students.studentNumber()}"></center></td>
                        </tr>
                    </#list>
                    <tr>
                        <center>
