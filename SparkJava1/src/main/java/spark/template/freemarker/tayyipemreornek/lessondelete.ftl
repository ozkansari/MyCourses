    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="/lessondelete">Ders Sil</a></li>
...
<div class="container">
    <div class="jumbotron">
        <center>
            <form action="/lessonlist" method="POST" accept-charset="utf-8">
                <h1>Medipol Üniversitesi Ders Listesi</h1>
                <table border="2" width="1000" align="center">
                    <center><td colspan="3"><a href="/lessondelete"><center><input type="submit" class="btn btn-default" value="Seçili Dersi Listeden Sil"/></center></a></td></center>
                    <tr>
                    ...
                    <#list lessons as lessons>
                        <tr>
                            ...
                            <td><center><input type="radio" id="delete" name="delete" value="${lessons.lessonID()}"></center></td>
                        </tr>
                    </#list>
                    <center><td colspan="3"><a href="/lessondelete"><center><input type="submit" class="btn btn-default" value="Seçili Dersi Listeden Sil"/></center></a></td></center>
                </table>
