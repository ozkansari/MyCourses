...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/dersekle">Ders Ekle</a></li>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>Ders Ekle</h1>
            <form class="form-inline" method="POST" action="/derseklepost">
                <div class="form-group">
                    <label for="name">Ders Adı</label>
                    <input type="text" class="form-control" id="Ad" name="Ad">
                </div>
                <div class="form-group">
                    <label for="name">Ders Akts</label>
                    <input type="text" class="form-control" id="Akts" name="Akts">
                </div>
                <div class="form-group">
