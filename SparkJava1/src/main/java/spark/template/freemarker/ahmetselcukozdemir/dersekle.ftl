...
<html>
		...
		<!-- Static navbar -->
	      ...
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-default" href="ogrenciler">Ahmet Selçuk</a>
	        </div>
  ...
  <label for="example-text-input" class="col-2 col-form-label">Ders Adý</label>
  <div class="col-10">
...
<br>
<div class="form-group row">
  <label for="example-search-input" class="col-2 col-form-label">Ders Hoca Adý</label>
  <div class="col-10">
