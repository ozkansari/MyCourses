package tr.edu.medipol.odevler.umutcan_meric.odev1;
...
public class HesapMakinesi {
	...
	public static void main(String[] args) {
		...
		int buyukDeger_sonuc=buyukDeger(sayi1,sayi2);
		...
		System.out.println("BÃ¼yÃ¼k SayÄ± sonucu: "+buyukDeger_sonuc);
