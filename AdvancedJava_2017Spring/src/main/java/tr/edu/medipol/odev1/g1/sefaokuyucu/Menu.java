...
/**
 * Muzaffer Anlas, Ahmet Selçuk Ozdemir, Bayram Ozkan Mutlu, Resul Vural ile cok benzer.
 */
public class Menu {
	...
	public static void MenuGoster()
	{
		...
		System.out.println("0-) Programdan ��k��");
	...
	{
		System.out.println("�sim soyisim giriniz: ");
		String adSoyad = MenuSec.nextLine();

		System.out.println("��renci Tipini Griniz (MYO/Lisans/Y�ksekLisans/Doktora");
		String ogrenciTip =  MenuSec.nextLine();

		System.out.println("Ogrenci B�l�m Giriniz: (Doktor,Hukuk,Finans.. vs.. )");
		...
		if (ogrenciTip.equals("YL")) {
			...
			yeniOgrenci = new OgrenciDoktora(adSoyad, bolum);
		}
	...
	public static void dosyaYaz() {
		...
		if (OgrenciListesi.isEmpty()) {
			System.out.println("<< Sisteme yeni ��renci girilmedi. Kay�t ba�ar�s�z! >>");
			return;
		} else {
