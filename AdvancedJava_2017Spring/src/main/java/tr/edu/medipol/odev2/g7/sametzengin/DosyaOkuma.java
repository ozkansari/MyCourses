package tr.edu.medipol.odev2.g7.sametzengin;
...
static DefaultListModel dm;
	...
	public static void main(String[] args) throws IOException {
		...
		adl = new JLabel("�sim Soyisim :");
		panel.add(adl);
		adl.setBounds(30, 35, 100, 30);
		adt = new JTextField();
		adt.setBounds(145,23, 210, 25);
		panel.add(adt);
		
		
		boluml = new JLabel("��rencinin B�l�m� :");
		boluml.setBounds(30, 90, 100, 30);
		panel.add(boluml);
		bolumt = new JTextField();
		bolumt.setBounds(150,85, 220, 25);
		panel.add(bolumt);
		
		tipl = new JLabel("Ogrenci Tipi :");
		tipl.setBounds(30, 35, 100, 30);
		panel.add(tipl);
		tipt = new JTextField();
		...
		listele = new JButton("Ogrenci Listele");
