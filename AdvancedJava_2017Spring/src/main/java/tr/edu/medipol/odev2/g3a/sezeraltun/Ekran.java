...
public class Ekran extends JFrame implements ActionListener {
	...
	public Ekran(){
		...
		final JButton btnekle = new JButton("\u00D6grenci Ekle");
		btnekle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!ogrenciadi.getText().equals("")) {
					...
					console.setText("Son Eklenen Kisi : " + "' " + ogrenciadi.getText() + " '" + " - " + "' " + ogrencibolum.getText() + " '" + " - " + "' " + txttip.getText() + " '");
				    
					
					if (e.getSource() == btnekle){
						sorgu = ogrenciadi.getText();
						
						JOptionPane.showMessageDialog(null, sorgu + " Adli Ogrencisi Eklendi.");
		...
		final JButton btnlstopen = new JButton("\u00D6grenci Listesi A\u00E7");
		...
		final JButton btnlstkaydet = new JButton("Dosyayi Kaydet");
		btnlstkaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				}}else{JOptionPane.showMessageDialog(null, "Liste Bos Kayit Yapilamaz!");}
				}
		});
		...
		final JButton btnlstclose = new JButton("\u00D6grenci Listesi Kapat");
	...
	public static void main(String[] args) {
		...
		ekran.setTitle("2.Proje �devi (Sezer �zaltun)");
