package tr.edu.medipol.odevler2.ahmet_ciloglu;
...
class Ekran {
	public static final String VERITABANI_DIZINI = ".\\.veritabani\\";
...
// OZKANS DUZELTME
	...
	public Ekran() throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		String Ogrenci = "ogrenciler";

		// TABLO OLUSTURMA ISLEMI
		try {

			stmt.executeUpdate("CREATE TABLE " + Ogrenci + " (" + "ogrenci_id int primary key identity(1,1) "
