package tr.edu.medipol.odevler2.numan_gungur;
import java.sql.*;
		...
		class ogrenciEkleVeriTabani implements ActionListener {
			public void actionPerformed(ActionEvent e) {
				...
				if((eslestiMiAd && eslestiMiSoyad && eslestiMiBolum && eslestiMiGirisYili) == true ){
					...
					JOptionPane.showConfirmDialog(null, "Sayi girmediniz\"",
							"Sayi degeri hatasi", JOptionPane.CLOSED_OPTION);
				}
				
				else{
					JOptionPane.showConfirmDialog(null, "Boş deger bulunmakta\"",
							"Sayi degeri hatasi", JOptionPane.CLOSED_OPTION);
				}
...
ogrenciEkle.addActionListener(new ogrenciEkle());jform.setVisible(true);

final String VERITABANI_DIZINI = 
".\\.veritabani\\";

final String VERITABANI_URL = 
"jdbc:derby:" + VERITABANI_DIZINI + ";create=true";

//OZKANS DUZELTME public static void main (String[] konsolParametreleri) throws Exception {
...
String tabloAdi = "ogrenci Bilgileri";
