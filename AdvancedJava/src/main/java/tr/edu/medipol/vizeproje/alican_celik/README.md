...
** (3/10) Yayın evi için sisteme eklenenler arasından seçim yaptırılmalıdır. 
...
* (2/10) Uygulamanızda Kitap ve Yayinevi isimli sınıflar tanımlanmalı ve bunlar sistemde ArrayList olarak tutulmalı.
