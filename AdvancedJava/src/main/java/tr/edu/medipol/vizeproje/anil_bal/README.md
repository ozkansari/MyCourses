...
** (3/5) Sayfa sayısı alanına sayı dışında bir değer girilmesine izin verilmemelidir. 
** (0/5) Aynı şekilde boş girişe de izin verilmemelidir.
...
//----------------------------------------------------------
DIGER:
(-10) Arayuz sinifindaki degisken isimleriTR karakterli oldugundan sorunluydu, derlenmiyordu. Duzeltildi. 
(-10) Geri donus mumkun degildi. Panel ana set visible falselar kaldirildi.
