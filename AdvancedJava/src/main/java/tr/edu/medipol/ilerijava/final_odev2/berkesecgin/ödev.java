package tr.edu.medipol.ilerijava.final_odev2.berkesecgin;
...
public class ödev {
	...
	public static void main(String[] args) {
		...
		FreeMarkerRoute indexSayfa = new FreeMarkerRoute("/odev/ogrenciekle") {
			...
			public Object handle(Request arg0, Response arg1) {
				return new ModelAndView(null, "/berkesecgin/finalodev2/ogrenciekle.html");
			}
		};
		get(indexSayfa);
		...
		FreeMarkerRoute indexSayfa2 = new FreeMarkerRoute("/odev/ogretmenekle") {
			@Override
			public Object handle(Request arg0, Response arg1) {
				return new ModelAndView(null, "/berkesecgin/finalodev2/ogretmenekle.html");
			}
		};
		get(indexSayfa2);
	...
	private static class OgrencilerSayfasiFreemarkerRoute extends FreeMarkerRoute {
		...
		public Object handle(Request arg0, Response arg1) {
			...
			return new ModelAndView(sayfaVerisi, "/berkesecgin/finalodev2/ogrenciler.html");
		}
	}
}
