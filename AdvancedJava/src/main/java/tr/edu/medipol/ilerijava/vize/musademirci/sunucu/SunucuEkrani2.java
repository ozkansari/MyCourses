package tr.edu.medipol.ilerijava.vize.musademirci.sunucu;
...
public class SunucuEkrani2 extends EkranUstSinif2 {
	...
	public synchronized void mesajEkle(String mesaj) {
		...
		/*
		 * // 2. yontem String mesajStr = new String(); for (String msj : mesajList) {
		 * mesajStr += msj + "\n"; } mesajlarJTF.setText(mesajStr);
		 * 
		 * // 3. yontem : java 8 final StringBuilder sb = new StringBuilder();
		 * mesajList.forEach( msj -> { sb.append(msj + "\n"); });
