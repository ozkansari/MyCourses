...
import tr.edu.medipol.ilerijava.vize.musademirci.ortak.EkranUstSinif2;
import tr.edu.medipol.ilerijava.vize.musademirci.ortak.SocketOkuyucuThread4;
import tr.edu.medipol.ilerijava.vize.musademirci.ortak.SocketYaziciThread4;
import tr.edu.medipol.ilerijava.vize.musademirci.sunucu.SocketSunucu4;
...
public class SocketIstemci4 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			System.out.println("Sunucuya baglanirken bilinmeyen bir hata alindi:" + e.getMessage());
			baglantiBasarili = false;
		} finally {
			if (!baglantiBasarili) {
		...
		SocketOkuyucuThread4 t = new SocketOkuyucuThread4(sunucuBaglantisi, false, istemciEkrani);
		t.start();
