...
public final class SocketYardimciAraclari3 {
	...
	public static BufferedReader socketOkuyucuOlustur(Socket istemciRef) {
		...
		try {
			...
			System.out.println("Istemci okuyucu acilirken hata: " + e.getMessage());
		}
	...
	public static PrintWriter socketYaziciOlustur(Socket sunucuBaglantisi) {
		...
		try {
			...
			sunucuMesajGonderici = new PrintWriter(outputStream);
		} catch (IOException e) {
			System.out.println("Sunucuya yazma akisi olustururken hata alindi:" + e.getMessage());
		}
