...
public class Anasayfa {
	...
	private static void anaSayfaGET() {
		...
		FreeMarkerRoute anaSayfa = new FreeMarkerRoute("/emretanrisever/" // Sayfaya hangi URL ile
			...
			public Object handle(Request istek, Response cevap) {
				...
				return new ModelAndView(sayfaVerisi, "/emretanrisever/finalproje/anasayfa.html" // spark/template/freemarker/
