package tr.edu.medipol.ogrenciler.batinarslan.odev5;
...
- Muhittin Ayrı (57) ile benzer ödev. 
- Benzerlik nedeniyle: -25 puan
...
public class Odev5Test extends Odev5Islemler{
	...
	public static void main(String[] args) {
        ...
        System.out.println("list1: " + List + "Ogrenci No: " + ogrenci.getNo() +" Ad Soyad: " + ogrenci.getAdSoyad() + " Ogrenci Tipi: " + ogrenci.ogrenciTipi() );
        
        
		List<Ogrenci> OgrenciListeleSral = new ArrayList<Ogrenci>();
		islemlerOgrenci.ogrenciList();
		Collections.sort(OgrenciListeleSral);
		System.out.println("Sral List: " + OgrenciListeleSral + "Ogrenci No: " + ogrenci.getNo() +" Ad Soyad: " + ogrenci.getAdSoyad() + " Ogrenci Tipi: " + ogrenci.ogrenciTipi() );
        ...
        System.out.println("Linkedlist: " + linkedlist + "Ogrenci No: " + ogrenci.getNo() +" Ad Soyad: " + ogrenci.getAdSoyad() + " Ogrenci Tipi: " + ogrenci.ogrenciTipi() );
       
        
        
        
        Set<Ogrenci> ListeleSet = new HashSet<Ogrenci>();
        islemlerOgrenci.ogrenciSet();
        ListeleSet.forEach(System.out::println);
        System.out.println("SET: " + ListeleSet + "Ogrenci No: " + ogrenci.getNo() +" Ad Soyad: " + ogrenci.getAdSoyad() + " Ogrenci Tipi: " + ogrenci.ogrenciTipi() );
        ...
        System.out.println("sortedSet1: " + sortedSet1 + "Ogrenci No: " + ogrenci.getNo() +" Ad Soyad: " + ogrenci.getAdSoyad() + " Ogrenci Tipi: " + ogrenci.ogrenciTipi() );
