package tr.edu.medipol.ogrenciler.anilokumus.odev6;
...
public class Odev6Islemler extends IslemlerGeneric<Ogrenci,String>{
	...
	@Override
	public Ogrenci kayitBul(String kayitNumarasi) {
		for(int i=0; i<kayitlar.size(); i++){
			Ogrenci ogrenci = kayitlar.get(i);
			if(ogrenci.getNo().equals(kayitNumarasi))
			{
